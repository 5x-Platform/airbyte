...
class AzureOneLakeBeanFactory {
    ...
    fun aggregatePublishingConfig() =
        AggregatePublishingConfig(
            ...
            maxEstBytesPerAgg = 150_000_000L, // 150 MB per aggregate
    ...
    /**
     * OneLake may not tolerate concurrent modifications when creating tables (stream init).
     * Use serial initialization to avoid conflicts.
     */
    @Singleton
    ...
    /**
     * Socket configuration for Azure OneLake destination.
