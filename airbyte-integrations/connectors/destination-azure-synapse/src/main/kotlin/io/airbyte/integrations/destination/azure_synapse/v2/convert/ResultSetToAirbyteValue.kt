...
import io.airbyte.integrations.destination.azure_synapse.v2.AzureSynapseQueryBuilder
import io.airbyte.integrations.destination.azure_synapse.v2.AzureSynapseQueryBuilder.NamedValue
...
class ResultSetToAirbyteValue {
    companion object {
        fun ResultSet.getAirbyteNamedValue(field: AzureSynapseQueryBuilder.NamedField): NamedValue =
